...
export default function Duas() {
    ...
    const Duas = [
      ...
      },
      {
        ...
        "roman":"dhahabadh dhama-u wabtallatil ‘urooqu, wa tha-batal ajru insha Allah"
      }
    ]
  return (
    <>
     ...
     <div className={classNames("tabs is-centered")}>
      ...
      {
        Duas.map((dua,key)=>(
          <div key={key} className={classNames("dua","has-text-centered","px-3",{"is-hidden":duaIdx!=key})}>
            <h2 className="amiri is-size-2 is-size-4-mobile">{dua["arabic"]}</h2>
